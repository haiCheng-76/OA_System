	...
	<div class="container">
		<div class="row clearfix">
			<div class="col-md-12 column">
				<form id="uploadfile" role="form" class="form-horizontal"
					enctype="multipart/form-data">
					<div class="form-group">
						<label for="uploader">上传者</label> <select selectpicker show-tick
							form-control data-style="btn-info" id="uploader" name="uploader"></select>
					</div>
					<div class="form-group">
						<label for="uploadFile">文件上传</label><input type="file" id="file"
							name="file" />
						<p class="help-block">上传的文件别太大!!!!!</p>
					</div>
